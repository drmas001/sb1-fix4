      ...
      <View style={styles.table}>
        ...
        {patients.map((patient) => (
          <View style={styles.tableRow} key={patient.mrn}>
            ...
            <View style={styles.tableCol}><Text style={styles.tableCell}>{patient.specialty || (patient as Consultation).consultation_specialty}</Text></View>
            <View style={styles.tableCol}><Text style={styles.tableCell}>{patient.patient_status || (patient as Consultation).status}</Text></View>
            <View style={styles.tableCol}><Text style={styles.tableCell}>{patient.diagnosis || (patient as Consultation).requesting_department}</Text></View>
          </View>
        ))}
      </View>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredPatients.map((patient) => (
                    <tr key={patient.mrn}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{patient.specialty || (patient as Consultation).consultation_specialty}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{patient.diagnosis || (patient as Consultation).requesting_department}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
